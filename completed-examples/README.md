...
These are the **starter** output (5 files). The full templates in `reference-materials/full-templates/` generate ~28 files including docs, multiple skills, hooks, commands, and a memory system.
